...
项目接入、配方、驾驶舱、时间返还、主动 Worker、会议闭环、GitHub Draft PR、受治理工作图和第 019/020/021 号迁移目前属于工作区候选。第 021 号迁移只增加加密的图投影表与索引，图仍是可重放的解释层，不能授权、扣预算、批准或执行。未完成提交、推送、同 SHA 云端检查、生产门禁、本机发布和服务回读前，不得写成“生产已部署”。
