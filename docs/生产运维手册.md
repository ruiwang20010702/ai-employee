...
项目接入、配方、驾驶舱、时间返还、主动 Worker、会议闭环、GitHub Draft PR、受治理工作图和第 019/020/021 号迁移已随生产提交 `34d04326d1d16ba92994107eb2f44bf89d74c759` 部署。第 021 号迁移只增加加密的图投影表与索引，图仍是可重放的解释层，不能授权、扣预算、批准或执行。当前生产能力仍只有 `draft_reply`，项目授权为 0，自动发送、计划执行和 `proactive_work` 均保持关闭。
