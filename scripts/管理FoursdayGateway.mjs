...
if (flags.some((flag, index) =>
  ...
  throw new Error("Usage: 管理FoursdayGateway.mjs <status|install-shadow|start-shadow|activate|stop|restart|uninstall|remove-profile> [--apply] [--acceptance /private/receipt.json --release-sha FULL_SHA --confirm VALUE]");
}
const argument = (name) => {
