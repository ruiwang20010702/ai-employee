...
export async function initializeProductionConfig({
  ...
  values.AI_EMPLOYEE_PERSONAL_MEMORY_WRITE_ENABLED = false;
  values.AI_EMPLOYEE_PERSONAL_MEMORY_GIT_REMOTE = "";
  values.AI_EMPLOYEE_PERSONAL_MEMORY_GIT_BRANCH = "main";
  values.AI_EMPLOYEE_PERSONAL_MEMORY_WRITER_ROOT = "";
  values.AI_EMPLOYEE_PERSONAL_MEMORY_GBRAIN_PATH = "";
  values.GH_PATH = "";
